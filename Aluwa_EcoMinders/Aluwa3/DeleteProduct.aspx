<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteProduct.aspx.cs" Inherits="Aluwa3.WebForm1" %>
 ...
 <body style = "background-color : #D9D4C9">
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <asp:Button ID="btnDelete" runat="server" CssClass="btn-delete" Text="Delete Product" OnClick="btnDelete_Click" />
