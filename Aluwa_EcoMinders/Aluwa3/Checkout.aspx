<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="Aluwa3.Checkout" %>
...
<body style = "background-color : #D9D4C9">		
	...
	<header class="header">
	    <h1>Checkout</h1>
			...
			<form action="Checkout.aspx" class="form" method="POST" runat="server">
				<div>
					<h2>Address</h2>

					<div class="card">
					<address>
						<label for = "lblAddress"> </label>
						<textarea id="Labeladdress" name="userAddress"> </textarea>
					</address>
					</div>
				</div>
				...
				<fieldset>
					...
					<div class="form__radios">
						<div class="form__radio">
							...
							<input checkedid="visa" name="payment-method" type="radio" />
						</div>
					...
					<div>
						...
						<table>
							<tbody>
							  <tr>
								<td>Free Shipping</td>
								<td align="right"><label style = "border:black"></label></td>
							  </tr>
							  <tr>
								<td>VAT 15%<span id="vat"></span></td>
								<td align="right"><asp:Label ID="lblVat" runat="server"></asp:Label></td>
							  </tr>
							  <tr>
								<td>Subtotal<span id="sub"></span></td>
								<td align="right"><asp:Label ID="lblSub" runat="server"></asp:Label></td>
							  </tr>
							</tbody>
							<tfoot>
							  <tr>
					...
					<div>
						...
						<asp:Button id="btnCheckOut" class="button button--full" type="submit" OnClick="btnCheckOut_Click" runat="server" Text="CheckOut"/>
					</div>
			</form>
		</div>
